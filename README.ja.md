...
Marionette は、未検証の「トークン削減」を単独で主張するのではなく、クロススタックなコンテキスト圧縮を重視します。画面、状態遷移、アクションハンドラを Go に寄せることで、バックエンドとフロントエンドの境界を減らし、スキーマ受け渡しや説明量の削減につなげます。その結果として、AI ツールに変更内容を伝えるときもプロダクトの流れに集中しやすくなり、補助的な効果としてトークン消費を抑えやすくなります。
...
- AI-friendly ガイド: https://yoshihideshirai.github.io/marionette/ja/ai-friendly/
