...
func usageSnippet(id string) string {
    ...
    Size:    "sm",
		...
		"theme-toggle-button": `themeToggle := mf.ThemeToggleButton("/toggle-theme", "Toggle theme", mf.ComponentProps{
    Variant: "ghost",
    Size:    "sm",
})`,
		"input": `startDate := mf.InputWithOptions("start_date", "2030-01-01", mf.InputOptions{
    Type:        "date",
    ...
    Open: true,
		...
		"empty-state": `emptyUsers := mf.EmptyState(mf.EmptyStateProps{
    Title:       "No users",
    ...
    Options: mf.ChartOptions{
		...
		"pagination": `pager := mf.Pagination(mf.PaginationProps{
    Page:       2,
    TotalPages: 4,
    ...
    mf.FormFieldProps{
		...
		"tabs": `tabs := mf.Tabs(mf.TabsProps{
    ...
    Items: []mf.TabsItem{
		...
		"breadcrumb": `breadcrumb := mf.Breadcrumb(mf.BreadcrumbProps{
    ...
    Gap:        "lg",
		...
		"page-header": `header := mf.PageHeader(mf.PageHeaderProps{
    Title:       "Users",
...
alert := mf.Alert(mf.AlertProps{
    ...
    Props:       mf.ComponentProps{Variant: "error", Size: "lg"},
		...
		"chart-line": `trend := mf.Chart(mf.ChartProps{
    Type:   mf.ChartTypeLine,
    ...
    Datasets: []mf.ChartDataset{{
		...
		"chart-bar": `breakdown := mf.Chart(mf.ChartProps{
