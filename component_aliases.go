...
func InputComponent(name, value string, props ComponentProps) Node { return UIInput(name, value, props) }
func InputWithOptions(name, value string, options InputOptions) Node { return UIInputWithOptions(name, value, options) }
func TextareaComponent(name, value string, options TextareaOptions) Node { return UITextarea(name, value, options) }
...
func SelectComponent(name string, options []SelectOption, props ComponentProps) Node { return UISelect(name, options, props) }
...
func DataFrameChart(df *rdf.DataFrame, props DataFrameChartProps) Node { return UIDataFrameChart(df, props) }
...
func ContainerComponent(props ContainerProps, children ...Node) Node { return UIContainer(props, children...) }
