...
func Hero(title, description string, actions ...Node) Node         { return daisy.Hero(title, description, actions...) }
...
func TimelineItem(startLabel, endLabel string, content Node) Node  { return daisy.TimelineItem(startLabel, endLabel, content) }
func Collapse(title string, content Node, open bool) Node          { return daisy.Collapse(title, content, open) }
